...
public class ClickHouseLikeEventWriter : IClickHouseLikeEventWriter
{
    ...
    public async Task AppendAsync(LikeEvent likeEvent)
    {
        ...
        cmd.Parameters.Add(new ClickHouseDbParameter { ParameterName = "p0", Value = likeEvent.EventId.ToString() });
        cmd.Parameters.Add(new ClickHouseDbParameter { ParameterName = "p1", Value = likeEvent.NewsId.ToString() });
